...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [
      { path: 'index',
        component: _import('missionManage/index'),
        name: 'missionManage',
        meta: {
          title: 'missionManage',
          icon: 'mission',
  ...
  // ---------------requester---------------
  {
    ...
    children: [
      { path: 'index',
        component: _import('buildMission/index'),
        name: 'buildMission',
        meta: {
          title: 'buildMission',
          icon: 'add',
  ...
  // ---------------worker---------------
  {
    ...
    children: [
      { path: 'index',
        component: _import('newMissions/index'),
        name: 'newMissions',
        meta: {
          title: 'newMissions',
          icon: 'add',
  ...
  {
    path: '/picTag',
    component: _import('picTag/index'),
    hidden: true,
    meta: {
      roles: ['worker']
    }
  ...
  {
    path: '/checkAnswer',
    component: _import('checkAnswer/index'),
    hidden: true,
    meta: {
      roles: ['worker']
    }
